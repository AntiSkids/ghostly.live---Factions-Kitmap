...
public class CitadelCreateProcedure {

    @Getter
    @Setter
    private CitadelCreateProcedureStage stage;
    @Getter
    @Setter
    private String name;
    @Getter
    ...
    public CitadelCreateProcedure() {
        pillars = new ClaimPillar[2];
    }

    public static ItemStack getWand() {
        return new ItemBuilder(Material.DIAMOND_HOE).name(ChatColor.GREEN + "Citadel Zone Selection").lore(Arrays.asList(
    ...
    public static Inventory getConfirmationInventory(CitadelCreateProcedure procedure) {
        Inventory toReturn = Bukkit.createInventory(null, 18, ChatColor.RED + "Confirm Citadel?");
