package live.ghostly.hcfactions.factions;
    ...
    public static void load() {
        ...
        sCollection.find().forEach(new Block() {
            ...
            public void apply(Object obj) {
                ...
                boolean pvpWall = dbo.getBoolean("pvpwall") == null ? false : dbo.getBoolean("pvpwall");
                ...
                systemFaction.setPvpWall(pvpWall);
        ...
        pCollection.find().forEach(new Block() {
            ...
            public void apply(Object obj) {
                ...
                Set<UUID> coleaders = new HashSet<>();
                ...
                List<String> coleadersList = (List<String>) dbo.get("coleaders");

                if (coleadersList != null) {
                    for (String coleader : coleadersList) {
                        if (coleader.length() == uuid.toString().length()) {
                ...
                playerFaction.setCoLeaders(coleaders);
        ...
        if (!(getFactions().isEmpty())) {
            ...
            for (Faction faction : getFactions()) {
                if (faction instanceof PlayerFaction) {
                    ...
                    coleaders.addAll(PlayerUtility.getConvertedUuidSet(playerFaction.getCoLeaders()));
                    ...
                    dbo.put("pvpwall", systemFaction.isPvpWall());
