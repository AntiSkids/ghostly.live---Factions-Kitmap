...
public class ClaimListeners implements Listener {
    ...
    public void onPlayerInteractClaim(final PlayerInteractEvent event) {
        ...
        if (event.getItem() != null && event.getItem().equals(Faction.getWand())) {
            ...
            if (faction instanceof PlayerFaction) {
                ...
                if (!playerFaction.getLeader().equals(player.getUniqueId()) && !playerFaction.getCoLeaders().contains(player.getUniqueId()) && !playerFaction.getOfficers().contains(player.getUniqueId()) && !player.hasPermission("hcf.bypass")) {
            ...
            if (event.getAction() == Action.LEFT_CLICK_AIR && player.isSneaking()) {
                ...
                if (faction instanceof PlayerFaction) {
                    ...
                    if (playerFaction.getBalance() < price && !player.hasPermission("hcf.bypass")) {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        if (player.getWorld().getEnvironment() == World.Environment.NETHER && this.getSpawnNetherLocation() != null && this.getSpawnNetherLocation().distance(event.getBlock().getLocation()) <= 300) {
            event.setCancelled(true);
            return;
        }
        ...
        if (claim != null) {
            ...
            if (faction instanceof SystemFaction && faction.getName().equalsIgnoreCase("Warzone")) {
                ...
                if (this.getSpawnLocation() != null && this.getSpawnLocation().getWorld() == event.getBlock().getLocation().getWorld() && this.getSpawnLocation().distance(event.getBlock().getLocation()) >= 700) {
                    return;
                }
            }

            if (faction instanceof SystemFaction && faction.getName().equalsIgnoreCase("Glowstone")) {
        ...
        if (claim != null) {
            ...
            if (faction instanceof SystemFaction && faction.getName().equalsIgnoreCase("Warzone")) {
                ...
                if (event.getBlock().getType() == Material.WEB) {
                    ...
                    }.runTaskLater(FactionsPlugin.getInstance(), 20L * 20);
                    return;
                }
    ...
    /*SubclaimListeners @EventHandler
    ...
    private Location getSpawnNetherLocation() {
        SystemFaction faction = SystemFaction.getByName("SpawnNether");
        if (faction != null && faction.getHome() != null) {
            return LocationSerialization.deserializeLocation(faction.getHome());
        }
        return null;
