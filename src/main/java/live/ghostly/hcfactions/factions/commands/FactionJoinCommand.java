...
import live.ghostly.hcfactions.factions.events.player.PlayerJoinFactionEvent;
...
public class FactionJoinCommand extends FactionCommand {
    ...
    public void onCommand(CommandArgs command) {
        ...
        if (faction == null || (!(faction instanceof PlayerFaction) || (!(playerFaction.getInvitedPlayers().containsKey(player.getUniqueId()))))) {
            ...
            if (playerFaction == null || !(playerFaction.getInvitedPlayers().containsKey(player.getUniqueId())) && !player.hasPermission("staff.developer")) {
