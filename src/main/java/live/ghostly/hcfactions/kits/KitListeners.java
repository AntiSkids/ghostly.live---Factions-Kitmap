package live.ghostly.hcfactions.kits;
...
import live.ghostly.hcfactions.kits.command.KitCommand;
            ...
            if (event.getCurrentItem().getType() == Material.STAINED_GLASS_PANE && event.getCurrentItem().getDurability() != 7) {
                ...
                if (kit != null) {
                    ...
                    if (event.getClick() == ClickType.RIGHT) {
                        ...
                        if (!player.hasPermission("hcf.kits")) {
                            player.sendMessage(ChatColor.YELLOW + "Purchase HCF Kits @ store.ghostly.live");
                            return;
                        }
