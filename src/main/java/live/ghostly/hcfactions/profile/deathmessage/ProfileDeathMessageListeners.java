package live.ghostly.hcfactions.profile.deathmessage;
    ...
    public void onPlayerDeathEvent(PlayerDeathEvent event) {
        ...
        if (player.getLastDamageCause() instanceof EntityDamageByEntityEvent) {
            ...
            if (entityEvent.getDamager() instanceof LivingEntity) {
                damager = (LivingEntity) entityEvent.getDamager();
            } else if (entityEvent.getDamager() instanceof Projectile) {
                if (((Projectile) entityEvent.getDamager()).getShooter() != null) {
                    damager = (LivingEntity) ((Projectile) entityEvent.getDamager()).getShooter();
                } else {
                    damager = null;
                }
            } else {
