package live.ghostly.hcfactions.profile.options;

import live.ghostly.hcfactions.profile.options.item.ProfileOptionsItem;
import live.ghostly.hcfactions.profile.options.item.ProfileOptionsItemState;
...
public class ProfileOptions {
    ...
    @Getter
    @Setter
    private boolean viewFoundDiamondMessages = true;
    @Getter
    @Setter
    private boolean viewDeathMessages = true;
    @Getter
    @Setter
    private boolean receivePublicMessages = true;
